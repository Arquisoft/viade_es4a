...
|===
|Codigo|Restricción |Descripción

|RT1|Implementación en React|La aplicación esta desarrollada en React. Esto quiere decir que nos limitaremos a las funcionalidades de React y Node js.
